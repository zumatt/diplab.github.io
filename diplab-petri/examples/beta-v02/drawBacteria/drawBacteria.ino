...
int petriD = (dispH/2)-10;                                  //Petri dish diameter -> 369
...
float step = petriD/10;                                     //Step of each line of bacteria
float bactRect = step/2;                                    //General dimension of the rectangle created to spread bacteria

void setup() {
  Serial.begin(115200);
  display.begin();                                      //Start the display
  //display.drawCircle(dispW/2, dispH/2, petriD, BLACK);  //Draw petri circle TO DELETE
