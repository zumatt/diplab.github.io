...
This part of the repository contains the personalised PCB created in order to add the accellerometer to the [Inkplate 6 PLUS](https://github.com/SolderedElectronics/Soldered-Inkplate-6PLUS-hardware-design).

![](https://raw.githubusercontent.com/zumatt/diplab/development/assets/DiPLab_Hardware_Image.png)

The board is based on the [LIS3DH accellerometer](https://www.st.com/resource/en/datasheet/lis3dh.pdf) component and the [easyC connector](https://soldered.com/easyC/) from Soldered Electronics.
Is it possible to use the accellerometer for any purpose including other boards using the 4 through-hole pins.
The shield is designed in collaboration with [Marco Lurati](https://github.com/marclura).
